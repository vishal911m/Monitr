...
import { FaCheck, FaGithub, FaMailBulk, FaMailchimp} from 'react-icons/fa';
...
function ProfileModal() {
  ...
  const handlePassword = (type: string) => (e: ChangeEvent<HTMLInputElement>) => {
    if (type === "old") {
      ...
      >
        ...
        <div className='mt-4 relative flex justify-between'>
          <div className='relative inline-block'>
            ...
            <div className='absolute bottom-0 right-1 shadow-sm'>
              <span className='text-lg text-blue-400'><FontAwesomeIcon icon={faCertificate} /></span>
        ...
        >
          ...
          <div className='pt-4 grid grid-cols-2 gap-4 border-t-2 border-t-[#323232]/10'>
            <div className='flex flex-col gap-1'>
              ...
              <input 
                ...
                className='py-[0.4rem] px-3 font-medium rounded-lg border-2 border-[#323232]'  
              />
            </div>
          ...
          <div className='flex justify-end gap-4 border-t-2 border-t-[#323232]/10'>
            ...
            <button
              type='submit'
              className='mt-3 py-2 px-4 bg-[#3aafae] text-black text-sm font-medium rounded-md border-2 border-[#323232]/10
